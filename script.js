...
const searchRoutes = [
  { keywords: ['tourist bus simulator', 'tourist bus', 'touristbussimulator', 'tbs'], target: 'TouristBusSimulator.html#bemutato' },
...
const vehicleData = {
  'econell-next': {
    ...
    gearbox: 'Automata',
    rarity: 'Ingyenes',
    comfort: 'Modern, csendes utastér',
    capacity: '92 fo',
  ...
  'volvo-regio': {
    ...
    type: 'Öregebb szóló helyközi busz',
    speed: '82 km/h',
    gearbox: 'Automata',
    rarity: 'Ingyenes',
    comfort: 'Klasszikus, öregebb szóló élmény',
    capacity: '61 fo',
    image: 'images/econell-12.png',
    route: '22',
    xpBonus: 19
  ...
  'credo-inovell': {
    name: 'Credo Inovell',
    type: 'Limited különlegesség',
    speed: '74 km/h',
    gearbox: 'Automata',
    rarity: 'Limited',
    comfort: 'Ritka és presztízs jármű',
    capacity: '78 fo',
  ...
  'ikarus-c80a': {
    name: 'Ikarus C80A',
    type: 'Retro különjárati busz',
    speed: '71 km/h',
    gearbox: 'Kézi váltó hangulattal',
    rarity: 'Limited',
    comfort: 'Nosztalgikus, karakteres vezetes',
    capacity: '72 fo',
    image: 'images/ikarus-c80a.png',
    route: 'Nosztalgia kör',
    xpBonus: 26
  },
  'ssm-econell': {
    name: 'SSM Econell 12',
    type: 'Mobil UI exkluziv busz',
    speed: '77 km/h',
    gearbox: 'Automata',
    rarity: 'Admin',
    comfort: 'Mobil UI-s, nagyon ritka különleges élmény',
    capacity: '90 fo',
    image: 'images/econell-next.png',
    route: 'Tulajdonosi meeting járat',
    xpBonus: 34
  }
};

const missionTemplates = [
  { text: 'Vidd le az 1-es járatot késés nélkül.', reward: 45, km: 18 },
  { text: 'Szállíts utasokat a 7A vonalon forgalmas időszakban.', reward: 55, km: 24 },
  { text: 'Teljesíts egy helyközi kört, és tartsd a menetrendet.', reward: 70, km: 42 },
        ...
        <article class="bus-card ${key === getSelectedVehicleKey() ? 'selected' : ''}" data-vehicle-key="${key}">
          ...
          <div class="bus-card-body">
            ...
            <ul class="bus-stat-list">
              <li>Gyorsaság: <strong>${vehicle.speed}</strong></li>
...
function buildDriverProfile(name) {
  ...
  const ranks = ['Újonc sofőr', 'Menetrend mestere', 'Helyközi profi', 'Volán veterán', 'Garázs legenda'];
...
const chatbotKnowledge = {
  ets2: {
    welcome:
      'Szia! Az ETS2-bot vagyok. Kérdezhetsz modokról, grafikai beállításokról, kezdő cégépítésről és DLC sorrendről is.',
    fallback:
      'Ehhez az ETS2-ben azt javaslom, hogy előbb a hivatalos DLC-ket nézd meg, utána építs stabil modlistát, és Full HD-ben közepes-magas grafikával kezdj.',
    rules: [
      {
        keywords: ['mod', 'modok', 'steam workshop'],
        answer:
          'ETS2 modlistához jó alap a térképmod, forgalommod, hangcsomag és egy minőségi trailer pack. Először a hivatalos DLC-ket érdemes beszerezni, utána jöhet a ProMods jellegű bővítés, reális forgalom és hangmod.'
      },
      {
        keywords: ['beállítás', 'grafika', 'fps', 'optimalizálás'],
        answer:
          'ETS2-ben első körben Full HD felbontás, 100-200% scaling, közepes tükrök és közepes árnyék jó kiindulás. Ha beesik az FPS, a tükrök minőségét és a vegetation részletességet vedd le előbb.'
      },
      {
        keywords: ['cég', 'kezdés', 'pénz', 'kezdő', 'indulás'],
        answer:
          'Kezdő ETS2 céghez gyors fuvarokkal gyűjts pénzt, majd vegyél egy megbízható, nem túltuningolt kamiont. A garázsbővítés és a sofőrök felvétele csak akkor jó, ha már stabil a bevételed.'
      },
      {
        keywords: ['dlc', 'ajánlott dlc', 'melyik dlc'],
        answer:
          'ETS2-ben a hivatalos térképes DLC-ket ajánlom elsőnek, mert ezek adják a legtöbb útvonalat és mod kompatibilitást. Utána a cargo és tuning DLC-k jöhetnek, ha már tudod, melyik stílusban játszol.'
      }
    ]
  },
  ats: {
    welcome:
      'Szia! Az ATS-bot vagyok. Modok, DLC-k, kezdő fuvarozós tippek és grafikai beállítások ügyében segítek.',
    fallback:
      'ATS-hez a legjobb kiindulás a hivatalos map DLC-k megnézése, aztán egy könnyű modlista és közepes-magas grafikai profil.',
    rules: [
      {
        keywords: ['mod', 'modok', 'truck'],
        answer:
          'ATS-ben jól működik együtt egy map expansion, egy jó sound pack, reális forgalom és néhány minőségi truck mod. A hivatalos DLC-k után érdemes modolni, mert így kevesebb az ütközés és nagyobb marad a térkép.'
      },
      {
        keywords: ['beállítás', 'grafika', 'fps'],
        answer:
          'ATS-hez Full HD vagy 1440p mellett közepes tükrök, közepes árnyék és visszafogott scaling a stabil választás. Ha sok városban leesik az FPS, a mirror distance és az SSAO az első, amit vedd vissza.'
      },
      {
        keywords: ['kezdés', 'pénz', 'cég', 'indulás'],
        answer:
          'ATS-ben eleinte rövidebb, biztos fuvarokat vállalj, ne a legerősebb kamionra költs. Amint megvan a saját gép és némi tartalék, onnan lehet szépen építeni a céget és bővíteni a flottát.'
      },
      {
        keywords: ['dlc', 'ajánlott dlc'],
        answer:
          'ATS-ben a legjobb első vétel a térképes DLC, mert több államot, hosszabb útvonalat és jobb mod alapot ad. A többi DLC utána jöhet ízlés szerint, főleg ha egy adott truck vagy cargo stílus érdekel.'
      }
    ]
  },
  omsi: {
    welcome:
      'Szia! Az OMSI-bot vagyok. Pályák, buszmodok, beállítások és DLC-k terén tudok gyors tippeket adni.',
    fallback:
      'OMSI-nál a stabilitás a legfontosabb: előbb a hivatalos DLC-ket és a stabil pályákat rakd össze, utána építs külön buszmod csomagot.',
    rules: [
      {
        keywords: ['mod', 'modok', 'busz', 'pálya', 'map'],
        answer:
          'OMSI-hoz a legjobb sorrend: stabil alapjáték, hivatalos DLC-k, utána megbízható pályák és buszmodok. Külön hangmod és AI-forgalom csomag sokat dob az élményen, de csak stabil alapra rakd fel őket.'
      },
      {
        keywords: ['beállítás', 'grafika', 'fps', 'lag'],
        answer:
          'OMSI 2-ben a látótáv és az AI-forgalom mennyisége fogja meg legjobban a gépet. Ha akad, a forgalmat, tükröket és objektum részletességet vedd le először, mert így marad vezethető a játék.'
      },
      {
        keywords: ['dlc', 'ajánlott dlc'],
        answer:
          'OMSI-hoz is érdemes előbb a hivatalos DLC-ket nézni, mert ezek adnak stabil pályát és járműalapot. Utána sokkal könnyebb kiválasztani, melyik magyar vagy külföldi mod passzol hozzád.'
      }
    ]
  },
  tourist: {
    welcome:
      'Szia! A Tourist Bus Simulator-bot vagyok. Tudok segíteni beállításokkal, cégkezdő tippekkel, casual modlistával és DLC-ajánlással is.',
    fallback:
      'Tourist Bus Simulatornál a sima indulás a fontos: közepes-magas grafika, óvatos cégbővítés, és ha van hivatalos DLC, azt a modok elé érdemes tenni.',
    rules: [
      {
        keywords: ['beállítás', 'grafika', 'fps', 'irányítás'],
        answer:
          'Tourist Bus Simulatorhoz jó kezdés a natív felbontás, közepes-magas textúra, közepes árnyék és visszafogott forgalom. Kontrollerrel érdemes enyhe kormányzási holtteret és finomabb fékerőt beállítani.'
      },
      {
        keywords: ['cég', 'kezdés', 'tippek', 'pénz', 'indulás'],
        answer:
          'Kezdő céghez előbb rövidebb turistajáratokat vállalj, hogy legyen fix bevételed és ne költs túl korán flottabővítésre. Egy megbízható busz, stabil útvonalak és kevés felesleges kiadás sokkal jobb rajtot ad.'
      },
      {
        keywords: ['mod', 'modok'],
        answer:
          'Tourist Bus Simulatornál inkább könnyű, látványos modlistát ajánlok: busz skin, kisebb UI vagy hangjavítás, és csak utána nagyobb járműcsomagok. Ha van hozzá hivatalos DLC, azt mindig a modok elé rakd a stabilitás miatt.'
      },
      {
        keywords: ['dlc', 'ajánlott dlc'],
        answer:
          'Ennél a játéknál is az a biztos sorrend, hogy ha elérhető hivatalos DLC, azt vedd előre, és csak arra építs rá modokat. Így kevesebb hibát kapsz és a mentésed is stabilabb marad.'
      }
    ]
  }
};
...
function getChatbotReply(gameKey, prompt) {
  const knowledge = chatbotKnowledge[gameKey];
  if (!knowledge) return 'A bot tudása most nem érhető el ehhez a játékhoz.';

  const normalizedPrompt = prompt.trim().toLowerCase();
  const matchedRule = knowledge.rules.find((rule) =>
...
function appendChatMessage(feed, role, text) {
  if (!feed) return;
  const message = document.createElement('article');
  message.className = `chat-message chat-message-${role}`;
  message.innerHTML = `
    <span class="chat-role">${role === 'bot' ? 'Bot' : 'Te'}</span>
...
function initializeChatbots() {
  const chatbotPanels = Array.from(document.querySelectorAll('[data-chatbot-game]'));

  chatbotPanels.forEach((panel) => {
    const gameKey = panel.getAttribute('data-chatbot-game');
    const knowledge = chatbotKnowledge[gameKey];
    ...
    const suggestionButtons = Array.from(panel.querySelectorAll('[data-chat-prompt]'));

    if (!knowledge || !feed || !form || !input) return;

    appendChatMessage(feed, 'bot', knowledge.welcome);
    ...
    form.addEventListener('submit', (event) => {
      ...
      appendChatMessage(feed, 'user', prompt);
      appendChatMessage(feed, 'bot', getChatbotReply(gameKey, prompt));
      input.value = '';
      input.focus();
    });
  });
